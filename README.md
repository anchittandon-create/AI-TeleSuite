...
1. **Current Application** – ships with the full feature set and relies on paid/artificial intelligence APIs (speech-to-text, text-to-speech, LLM scoring, etc.).
...
| Area | Current Application | Free Open Source Version |
|------|---------------------|--------------------------|
...
Re-enabling the commercial build simply requires reinstalling those dependencies, restoring the environment variables, and switching back to **Current Application** in the dropdown.
