...
import { Download, Loader2, Server, FileCode, AlertTriangle, Bot, Copy, FileText } from 'lucide-react';
...
async function fetchMasterPrompt(): Promise<string> {
    ...
    // Sort files based on the numeric prefix in their filename
    files.sort((a, b) => {
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-6 flex flex-col items-center space-y-6">
        ...
        <Card className="w-full max-w-4xl">
          <CardHeader>
            ...
            <CardDescription>
              Use this comprehensive prompt to have an AI agent replicate this application from scratch.
            </CardDescription>
          </CardHeader>
          <CardContent>
