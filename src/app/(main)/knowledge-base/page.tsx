...
import { Sheet, Trash2, Download, Lightbulb, MessageSquareReply, BookOpenText } from "lucide-react"; 
        ...
        <Card className="w-full max-w-4xl shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg flex items-center">
              ...
              Download AI Prompts & Logic
            </CardTitle>
            <CardDescription>
              Download a comprehensive text document containing the core AI prompts and guiding logic for all major features of AI_TeleSuite. This is provided for reference and understanding.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0">
              <Button onClick={handleDownloadFullPrompts} variant="outline" className="w-full sm:w-auto">
                <Download className="mr-2 h-4 w-4" /> Download Full AI Prompts & Logic
              </Button>
            </div>
            <p className="text-xs text-muted-foreground">
              Note: This document contains the base prompts. Modifying this downloaded file will not affect the application's AI behavior. The actual prompts sent to the AI include dynamic data based on your inputs and selected Knowledge Base content.
            </p>
          </CardContent>
        </Card>
