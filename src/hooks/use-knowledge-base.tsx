...
const defaultKnowledgeBase: KnowledgeFile[] = [
  ...
  // --- TimesHealth+ Yoga Product Entries ---
  {
    id: 'default-yoga-desc',
    name: 'Yoga by TimesHealth+ - Product Overview',
    type: 'text/plain',
    size: 650,
    product: 'timeshealth-yoga',
    category: 'Product Description',
    uploadDate: new Date().toISOString(),
    textContent: "Yoga by TimesHealth+ is a guided wellness journey created with the TOI editorial and TimesHealth+ coaching teams. Members get access to the TimesHealth+ dashboard (https://timeshealthplus.com/TH/dashboard), curated plan recommendations (https://timeshealthplus.com/TH/plans), and weekly 'Mindful Monday' sessions (http://timeshealthplus.com/TH/mindful-monday-yoga). Each plan blends guided yoga flows, breathing routines, and mindfulness nudges that fit into busy weekdays. It is ideal for working professionals looking to de-stress, parents seeking family-friendly routines, and students who want science-backed flexibility training.",
    isTextEntry: true,
  },
  {
    id: 'default-yoga-pitch',
    name: 'Yoga by TimesHealth+ - Sales Pitch',
    type: 'text/plain',
    size: 600,
    product: 'timeshealth-yoga',
    category: 'Pitch',
    uploadDate: new Date().toISOString(),
    textContent: "Hello {{userName}}, this is {{agentName}} from TimesHealth+. We just launched our new Yoga Journey in partnership with TOI experts. In a single membership you unlock the TimesHealth+ dashboard, Mindful Monday live classes, and structured plans that fit 15-minute breaks. Members tell us they feel calmer within the first week and stay consistent because we send personalised routines straight from https://timeshealthplus.com/TH/plans. Would you like me to walk you through the Mindful Monday yoga calendar or share the corporate wellness option?",
    isTextEntry: true,
  },
  {
    id: 'default-yoga-pricing',
    name: 'Yoga by TimesHealth+ - Pricing Snapshot',
    type: 'text/plain',
    size: 420,
    product: 'timeshealth-yoga',
    category: 'Pricing',
    uploadDate: new Date().toISOString(),
    textContent: "Yoga by TimesHealth+ is available in Monthly, Quarterly, and Annual plans. The Annual Journey includes unlimited Mindful Monday classes, access to every plan on https://timeshealthplus.com/TH/plans, and early invites to TOI wellness workshops. Team subscriptions are available under the Corporate Wellness Plan and include a dedicated success coach.",
    isTextEntry: true,
  },
  {
    id: 'default-yoga-rebuttal',
    name: 'Yoga by TimesHealth+ - Common Rebuttals',
    type: 'text/plain',
    size: 700,
    product: 'timeshealth-yoga',
    category: 'Rebuttals',
    uploadDate: new Date().toISOString(),
    textContent: "Objection: I already follow free YouTube yoga videos.\nRebuttal: Absolutely, and free sessions are a great way to get started. What members value about TimesHealth+ is the structured journey: the dashboard tracks streaks, coaches adjust routines when your schedule changes, and Mindful Monday yoga keeps you accountable because it is a live cohort.\n\nObjection: I don\'t have 60 minutes daily.\nRebuttal: The program was designed for busy TOI readers—most flows are 15–20 minutes, and the dashboard lets you schedule them around calls. The weekly live class is optional, and you can always replay the recording.\n\nObjection: Is there any science behind it?\nRebuttal: Yes. The program is curated with physio and psychology inputs from TimesHealth+ and published at https://timeshealthplus.com/TH/mindful-monday-yoga so members see the references for each routine.",
    isTextEntry: true,
  },
  {
    id: 'default-yoga-kb-upload-note',
    name: 'Yoga by TimesHealth+ - Doc Reference',
    type: 'text/plain',
    size: 520,
    product: 'timeshealth-yoga',
    category: 'General',
    uploadDate: new Date().toISOString(),
    textContent: "Reference doc for onboarding collateral: https://docs.google.com/document/d/1osDtKCFRO686355t3k2hqXN9pLU4B5BGkOrGGgTyX5c/edit?usp=sharing. Please download and upload the latest version if you need the full script. (The automated build cannot fetch Google Docs, so this entry tracks the URL and metadata only.)",
    isTextEntry: true,
  },
];
