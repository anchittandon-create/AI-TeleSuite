...
import { 
    ...
    Briefcase, Headset, FileLock2, BarChartBig, Activity, ChevronDown, DownloadCloud, PieChart, ShoppingBag, Radio, CodeSquare, PlusCircle, Server, Share2
} from "lucide-react";
...
const navStructure = [
  ...
  { type: 'item', href: "/n8n-workflow", label: "n8n Workflow", icon: Share2 },
];
