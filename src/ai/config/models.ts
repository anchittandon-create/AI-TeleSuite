...
export const AI_MODELS = {
   ...
   */
  TEXT_ONLY: 'googleai/gemini-1.5-flash',

  /**
   * Ultra-efficient model for simple tasks like rebuttal generation
   */
  BASIC_TEXT: 'googleai/gemini-1.5-flash',
} as const;
