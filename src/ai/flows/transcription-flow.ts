...
Prioritize accuracy in transcription, time allotment (ensure brackets), speaker labeling (ensure ALL CAPS), and transliteration above all else. Pay close attention to distinguishing pre-recorded system messages from human agent speech.
`,
  config: {
